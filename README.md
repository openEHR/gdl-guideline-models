...
2. Villalta Score for Post-thrombotic Syndrome (PTS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/villalta_score/1?language=en))
3. Elderly Mobility Scale (EMS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/EMS/1?language=en))
4. Pediatric Trauma BIG Score - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Pediatric_trauma_BIG_score/1?language=en))
...
* ACC/AHA Heart Failure Staging - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/ACC-AHA_Heart_Failure_Staging/1?language=en))
...
* CHADS2 Score - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/CHADS2/1?language=en))
...
* ORBIT Bleeding Risk Score for Atrial Fibrillation  - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/ORBIT_bleeding_risk_score/1?language=en))
...
* Transtubular Potassium Gradient (TTKG) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/transtubular_potassium_gradient_guideline/1?language=en))
...
* HEART Score - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/HEART_score_for_MACE/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/HEART_score_for_MACE/1?language=sv))
...
* AST to Platelet Ratio Index (APRI) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/APRI_AST_to_platelet_ratio_index/1?language=en))
...
* King's College Criteria for Acetaminophen Toxicity - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Kings_College_Criteria_for_Acetaminophen_Toxicity_guideline/1?language=en))
...
* Revised Original Score for Autoimmune Hepatitis (AIH) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/AIH_Revised_Original_Score_guideline/1?language=en))
...
* Cumulative Illness Rating Scale-Geriatric (CIRS-G) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Cumulative_Illness_Rating_Scale_Geriatric_CIRS_G/1?language=en))
...
* 4Ts for Heparin Induced Thrombocytopenia (4Ts for HIT) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/4TS_HIT/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/4TS_HIT/1?language=sv))
...
* Urinary Protein Excretion Estimation - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Urinary_Protein_Excretion_Estimation/1?language=en))
...
* Fisher Grading Scale for Subarachnoid Hemorrhage (SAH) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Modified_Fisher_Scale_SAH/1?language=en))
...
* OESIL Score for Syncope - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/OESIL_Score_guideline/1?language=en))
...
* FIGO Staging for Ovarian Cancer (2014) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/FIGO_Staging_for_Ovarian_Cancer_2014/1?language=en))
...
* Groupe d'Etude des Lymphomes Folliculaires (GELF) Criteria - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/GELF_criteria/1?language=en))
...
* Karnofsky Performance Status Scale - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Karnofsky_performance_status/1?language=en))

* Khorana Risk Score for Venous Thromboembolism in Cancer Patients - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Khorana_Risk_Score_Venous_Thromboembolism_Cancer_Patients/0?language=en))

* Mantle Cell Lymphoma International Prognostic Index (MIPI) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/MIPI_guideline/1?language=en))

* Modified Glasgow Prognostic Score (mGPS) for Cancer Outcomes - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Modified_Glasgow_Prognostic_Score/1?language=en))
...
* Multiple Myeloma Diagnostic Criteria - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Multiple_Myeloma_Diagnostic_Criteria/1?language=en))
...
* Prognostic Index for Cancer Outcomes - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Prognostic_Index_for_Cancer_Outcomes/1?language=en))

* Prostate Tumor Volume & Density - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Prostate_Tumor_Volume_Density/1?language=en))

* PSA Doubling Time (PSADT) Calculator - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/PSADT_guideline/1?language=en))
...
* Risk of Malignancy Index (RMI) for Ovarian Cancer - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Risk_of_malignancy_index_RMI_for_ovarian_cancer/1?language=en))

* Sokal Index for Chronic Myelogenous Leukemia (CML) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Sokal_Index_for_CML/1?language=en))

* Solitary Pulmonary Nodule (SPN) Malignancy Risk Score - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/SPN_Malignancy_risk_score/1?language=en))

* SSIGN Score for Clear Cell Renal Cell Carcinoma - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/SSIGN_ccRCC/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/SSIGN_ccRCC/1?language=sv))

* TNM for Breast Cancer - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/TNM_Breast/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/TNM_Breast/1?language=sv))

* TNM for Pancreatic Cancer - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/TNM_Pancreas/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/TNM_Pancreas/1?language=sv))

* TNM for Renal Cell Carcinoma - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/TNM_RCC/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/TNM_RCC/1?language=sv))

* UCLA Integrated Staging System (UISS) for Renal Cell Carcinoma (RCC) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/UCLA_Integrated_Staging_System_UISS_for_Renal_Cell_Carcinoma_RCC_guideline/1?language=en))

* UCSF-CAPRA Score for Prostate Cancer Risk - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/UCSF_CAPRA_prostate_cancer_risk/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/UCSF_CAPRA_prostate_cancer_risk/1?language=sv))

----------

### Ophthalmology

* Color Vision Screening (Ishihara Test) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Color_Vision_Screening/1?language=en))

* Ocular Hypertension Treatment Study (OHTS) Calculator - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Ocular_Hypertension_Treatment_Study_OHTS_Calculator/1?language=en))

* Visual Acuity Testing (Snellen Chart) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Visual_Acuity/1?language=en))
...
----------
* Ankylosing Spondylitis Disease Activity Score with CRP (ASDAS-CRP) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/ASDAS-CRP/1?language=en))

* Ankylosing Spondylitis Disease Activity Score with ESR (ASDAS-ESR) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/ASDAS-ESR/1?language=en))

* ASAS Criteria for Axial Spondyloarthritis (SpA) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/ASAS_Criteria_for_Axial_Spondyloarthritis_SpA_guideline/1?language=en))

* ASAS Criteria for Peripheral SpondyloArthritis (SpA) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/ASAS_criteria_for_Peripherial_SpA/1?language=en))

* Harris Hip Score - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Harris_hip_score/1?language=en))
...
* Recurrent Instability of the Patella (RIP) Score - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Recurrent_Instability_of_the_patella_RIP_score/1?language=en))

* Shoulder Pain And Disability Index (SPADI) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/SPADI/1?language=en))
...
----------
* Mirels’ Criteria for Prophylactic Fixation - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Mirels_Fracture_Risk_Score/1?language=en))

* Osteoporosis Index of Risk (OSIRIS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/OSIRIS_score/1?language=en))

* Osteoporosis Risk Assessment Instrument (ORAI) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Osteoporosis_risk_assessment_instrument_ORAI/1?language=en))

* Osteoporosis Self Assessment Tool for Women (OST) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/OST-Score/1?language=en))

* Simple Calculated Osteoporosis Risk Estimation (SCORE) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Osteoporosis_Risk_score_guideline/1?language=en))
...
----------
* Asthma Predictive Index (API) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Asthma_predictive_index/1?language=en))

* Behavioral Observational Pain Scale (BOPS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/BOPS/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/BOPS/1?language=sv))

* Brief Resolved Unexplained Events (BRUE) Criteria for Infants - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Brief_Resolved_Unexplained_Events_BRUE_Criteria_for_Infants_guideline/1?language=en))

* CATCH (Canadian Assessment of Tomography for Childhood Head injury) Rule - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/CATCH_childhood_head_injury_rule/1?language=en))
...
* Modified Asthma Predictive Index (mAPI) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Modified_Asthma_Predictive_Index_mAPI/1?language=en))

* Paradise Criteria for Tonsillectomy in Children - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Paradise_Criteria_guideline/1?language=en))

* PECARN Pediatric Intra-Abdominal Injury (IAI) Algorithm - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/PECARN_pediatric_intra_abdominal_injury_rule_guideline/1?language=en))

* PECARN Rule for Low Risk Febrile Infants 29-60 Days Old - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/PECARN_Rule_for_Low_Risk_Febrile_Infants_29-60_Days_Old/1?language=en))

* Pediatric Appendicitis Risk Calculator (pARC) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Pediatric_Appendicitis_Risk_Calculator_pARC/1?language=en))

* Pediatric Appendicitis Score (PAS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Pediatric_Appendicitis_Score_guideline/1?language=en))

* Pediatric Asthma Score (PAS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/PAS/1?language=en))

* Pediatric Crohn's Disease Activity Index (PCDAI) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/PCDAI/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/PCDAI/1?language=sv))

* Pediatric Early Warning Score (PEWS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/PEWS/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/PEWS/1?language=sv))

* Pediatric Early Warning Score (PEWS2) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/PEWS2_for0to3months/1?language=en))

* Pediatric Glasgow Coma Scale (pGCS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Pediatric_glasgow_coma_scale/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Pediatric_glasgow_coma_scale/1?language=sv))

* Pediatric ins and outs - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Pediatric_ins_and_outs/1?language=en))

* Pediatric Respiratory Assessment Measure (PRAM) for Asthma Exacerbation Severity - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Pediatric_Respiratory_Assessment_Measure_PRAM_for_Asthma_Exacerbation_Severity_guideline/1?language=en))

* Pediatric SIRS2 - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Pediatrics_Sirs2/1?language=en))
...
* Withdrawal Assessment Tool (WAT-1) for Pediatric Withdrawal - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Withdrawal_Assessment_Tool_for_pediatric_withdrawal/1?language=en))
----------

### Pharmacology

----------
* Acetaminophen Overdose and NAC Dosing - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Acetaminophen_Overdose_and_NAC_Dosing/1?language=en))

* Antivenom Dosing Algorithm - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/antivenom_dosing_algorithm/1?language=en))
...
* DigiFab (Digibind) Dosing for Digoxin Poisoning - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/DigiFab_Digibind_Dosing_for_Digoxin_Poisoning_guideline/1?language=en))

* Fomepizole Dosing - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Fomepizole_dosing/1?language=en))

* HERDOO2 Rule for Discontinuing Anticoagulation in Unprovoked VTE - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/HERDOO2_Rule_for_Discontinuing_Anticoagulation_in_Unprovoked_VTE/1?language=en))

* Hydroxychloroquine (Plaquenil) Dosing Calculator - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Hydroxychloroquine_Plaquenil_Dosing_Calculator/1?language=en))

* Insulin Dosage Calculator - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Insulin_Dosage_Calculator_guideline/1?language=en))

* Naloxone Drip Dosing - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Naloxone_Drip_Dosing_guideline/1?language=en))

* Phenytoin (Dilantin) Correction for Albumin / Renal Failure - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Phenytoin_correction_for_albumin_renal_failure/1?language=en))

* tPA (Tissue Plasminogen Activator) Dosing for Stroke Calculator - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/tPA_dosing_for_stroke_calculator/1?language=en))

* Vitamin-D Doses Range Recommendation - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Vitamin_D_Doses_Range_Recommendation/0?language=en))
...
* Drug Resistance in Pneumonia (DRIP) Score - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Drug_Resistance_in_Pneumonia_DRIP_Score/0?language=en))

* Duke Activity Status Index (DASI) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Duke_Activity_Status_Index_DASI/1?language=en))

* Dutch Lipid Clinic Network Criteria (DLCN) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/DLCN_score/1?language=en))

* Electronic Frailty Index - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Electronic_Frailty_Index/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Electronic_Frailty_Index/1?language=sv))

* Epworth Sleepiness Scale - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/ESS/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/ESS/1?language=sv))

* Estimated PEF-value - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/PEFR_estimated/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/PEFR_estimated/1?language=sv))

* Fatigue Severity Scale (FSS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Fatigue_Severity_Scale_FSS_guideline/1?language=en))
...
* INTERCHEST - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/INTERCHEST/1?language=en))

* International Prostate Symptom Score (IPSS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/IPSS/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/IPSS/1?language=sv))

* LDL Calculated - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/LDL/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/LDL/1?language=sv))

* Lower Extremity Functional Scale (LEFS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/LEFS/1?language=en))

* Manning Criteria for IBS - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Manning_Criteria_for_IBS/1?language=en))

* Marburg Heart Score (MHS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Marburg_Heart_Score/1?language=en))
...
* Oswestry Disability Index (ODI) For Low Back Pain - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/ODI/1?language=en))

* Pack Years Calculator - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Pack_Years_Calculator_guideline/1?language=en))

* Prediction of Alcohol Withdrawal Severity Scale - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Prediction_of_Alcohol_Withdrawal_Severity_Scale/1?language=en))

* ROME III for IBS - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Rome_III_IBS/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Rome_III_IBS/1?language=sv))

* ROME IV for Constipation - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Rome_IV_constipation/1?language=en))

* ROME IV for Dyspepsia - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Rome_IV_dyspepsia/1?language=en))

* ROME IV for IBS - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Rome_IV_IBS/1?language=en))

* Self-administered comorbidity questionnaire (SCQ) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/SCQ/1?language=en))

* Stress and Crisis Inventory 93 (SCI-93) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/SCI-93/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/SCI-93/1?language=sv))

* Upper Extremity Functional Index (UEFI) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/UEFI_guideline/1?language=en))

* World Health Organization Disability Assessment Schedule 2.0 - 12 item version (WHODAS 2.0) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/WHODAS_2.0_12_item_score/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/WHODAS_2.0_12_item_score/1?language=sv))

* World Health Organization Disability Assessment Schedule 2.0 - full 36 item version (WHODAS 2.0) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/WHODAS_2.0_36_item_scores/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/WHODAS_2.0_36_item_scores/1?language=sv))
...
----------
* Abbreviated Mental Test (AMT-10) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Abbreviated_mental_test_AMT_10/0?language=en))

* Adult Self Rating Scale for ADHD (ASRS-ADHD) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/ASRS_ADHD/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/ASRS_ADHD/1?language=sv))
...
* Clinical Institute Withdrawal Assessment for alcohol scale - revised (CIWA-Ar) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/CIWA-Ar/1?language=sv))

* Clinical Opiate Withdrawal Score (COWS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/COWS/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/COWS/1?language=sv))

* Columbia Suicide Severity Rating Scale (C-SSRS Screener) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Columbia_Suicide_Severity_Rating_Scale/1?language=en))

* Credibility and Expectancy Questionnaire (CEQ) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/CEQ/1?language=en))

* Drug Use Disorders Identification Test (DUDIT) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/DUDIT_score/1?language=en))

* DSM-5 Criteria for Major Depressive Disorder - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/DSM_5_Criteria_for_Major_Depressive_Disorder_guideline/1?language=en))
...
* Hamilton Depression Rating Scale (HAM-D) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Hamilton_Depression_rating_scale/1?language=en))

* Hospital Anxiety and Depression Scale (HAD) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/HAD_score/1?language=en))

* Impact of Event Scale - Revised (IES-R) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/IES-R/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/IES-R/1?language=sv))

* Major Depression Inventory (MDI) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/MDI/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/MDI/1?language=sv))

* Medical Outcomes Study - Social Support Survey (MOS-SSS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/MOS-SSS/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/MOS-SSS/1?language=sv))

* Metabolic Syndrome Criteria - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Metabolic_Syndrome_Criteria_guideline/1?language=en))

* Montgomery Åsberg Depression Rating Scale (MADRS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/MADRS/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/MADRS/1?language=sv))

* Montgomery Åsberg Depression Rating Scale Self-rated (MADRS-S) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/MADRS-S/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/MADRS-S/1?language=sv))

* Obsessive-Compulsive Inventory - revised (OCI-r) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/OCI-R/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/OCI-R/1?language=sv))

* Panic Disorder Severity Scale Self-Rated (PDSS-SR) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/PDSS_SR/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/PDSS_SR/1?language=sv))

* Patient Health Questionnaire-9 (PHQ-9) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/PHQ9/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/PHQ9/1?language=sv))

* Quick Inventory of Depressive Symptomology (QIDS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/QIDS/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/QIDS/1?language=sv))

* Ritvo Autism and Asperger Diagnostic Scale 14 (RAADS-14) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/RAADS-14/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/RAADS-14/1?language=sv))

* Social Phobia Inventory (SPIN) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/SPIN/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/SPIN/1?language=sv))

* Stanford Sleepiness Scale - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Stanford_Sleepiness_Scale_guideline/1?language=en))

* V-Risk (Violence-Risk) 10 - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/V-RISK_10/1?language=en))

* Yale-Brown Obsessive Compulsive Scale (Y-BOCS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/YBOCS/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/YBOCS/1?language=sv))

* Young Mania Rating Scale (YMRS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/YMRS/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/YMRS/1?language=sv))
...
----------
* A-a O₂ Gradient - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Aa_O2_gradient/1?language=en))

* A-a O₂ Gradient (simplified) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Aa_O2_gradient_simplified/1?language=en))

* A-a O₂ Gradient (complex) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/aa_o2_gradient_complex/1?language=en))

* Altitude-Adjusted PERC Rule - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/altitude_adjusted_perc_guideline/1?language=en))
...
* Diffusing Capacity Of The Lungs For Carbon Monoxide (DLCO) Calculator - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/DLCO/1?language=en))

* du Bois Score for Idiopathic Pulmonary Fibrosis (IPF) Mortality - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/du_Bois_IPF/1?language=en))

* BODE Index for COPD Survival - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/BODE_Index_COPD_survival/1?language=en))

* Bova Score for Pulmonary Embolism Complications - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Bova_Score/1?language=en))

* Clinical Pulmonary Infection Score (CPIS) for Ventilator-Associated Pneumonia (VAP) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Clinical_Pulmonary_Infection_Score_CPIS_for_Ventilator_Associated_Pneumonia_guideline/1?language=en))

* COPD Assessment Test (CAT) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/CAT_COPD_Assessment_Test/1?language=en))

* COVID-GRAM Critical Illness Risk Score - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/COVID-GRAM_Critical_Illness_Risk_Score_guideline/1?language=en))

* DECAF Score for Acute Exacerbation of COPD - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/DECAF_score_COPD/1?language=en))

* Fleischner Society Guidelines for Incidental Pulmonary Nodules - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Fleischner_Society_Guidelines_for_Incidental_Pulmonary_Nodules/1?language=en))

* GAP Index - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Gap_index_for_IPF_mortality/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Gap_index_for_IPF_mortality/1?language=sv))

* Global Initiative for Obstructive Lung Disease (GOLD) Criteria for COPD - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Global_Initiative_for_Obstructive_Lung_Disease_GOLD_Criteria_for_COPD_guideline/1?language=en))

* Gupta Postoperative Pneumonia Risk - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Gupta_postoperative_pneumonia_risk/1?language=en))
...
* Light's Criteria for Exudative Effusions - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Lights_Criteria_guideline/1?language=en))

* Manchester Score for small cell lung cancer - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Manchester_Score_SCC_lung/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Manchester_Score_SCC_lung/1?language=sv))

* MuLBSTA Score for Viral Pneumonia Mortality  - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/mulbsta/1?language=en))

* Murray Score for Acute Lung Injury  - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/murray_score/1?language=en))

* Ottawa COPD Risk Scale - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Ottawa_COPD_Risk_Scale_guideline/1?language=en))

* PERC Rule for Pulmonary Embolism - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/PERC/1?language=en))

* Prevention and Incidence of Asthma and Mite Allergy (PIAMA) Risk Score - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/PIAMA_Risk_Score/1?language=en))

* PSI/PORT Score - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/PSI-PORT_Pneumonia_Risk_Stratification/1?language=en))

* RADS (Radiologist’s Score) for Smoke Inhalation Injury - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/RADS_guideline/1?language=en))

* RAPID Score for Pleural Infection - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Rapid_Score/0?language=en))

* Respiratory ECMO Survival Prediction (RESP) Score - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/RESP_score_respiratory_ecmo_survival_prediction/1?language=en))

* REVEAL Registry Risk Score for Pulmonary Arterial Hypertension (PAH) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/REVEAL_score/1?language=en))

* RIETE Score for Risk of Hemorrhage in Pulmonary Embolism Treatment - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/RIETE_Score_Risk_Hemorrhage_Pulmonary_Embolism_Treatment/1?language=en))

* SMART-COP Score - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/SMART-COP_Score/1?language=en))

* Static Lung Compliance (Cstat) Calculation - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Cstat_Calculation_guideline/1?language=en))

* Veterans Health Administration COVID-19 (VACO) Index for COVID-19 Mortality - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/VACO_mortality_index/1?language=en))
----------

### Rheumatology

----------
* ACR EULAR Rheumatoid Arthritis - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/ACR_EULAR_RA/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/ACR_EULAR_RA/1?language=sv))

* Acute Gout Diagnosis Rule - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Acute_gout_diagnosis_rule/1?language=en))

* Age-Adjusted ESR/CRP for Rheumatoid Arthritis - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/age-adjusted_ESR_CRP_for_RA/1?language=en))

* Bath Ankylosing Spondylitis Functional Index (BASFI) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/BASFI_score_guideline/1?language=en))

* CASPAR Criteria for Psoriatic Arthritis - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/CASPAR_Criteria_for_Psoriatic_Arthritis/1?language=en))

* Clinical Disease Activity Index (CDAI) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/CDAI/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/CDAI/1?language=sv))

* Disease Activity Score 28-CRP (DAS28-CRP) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/DAS28-CRP/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/DAS28-CRP/1?language=sv))

* Disease Activity Score 28-ESR (DAS28-ESR) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/DAS28-ESR/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/DAS28-ESR/1?language=sv))

* Jones Criteria for Acute Rheumatic Fever Diagnosis - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/JonesCriteria/1?language=en))

* Leiden Clinical Prediction Rule for Undifferentiated Arthritis - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Leiden_Clinical_Prediction_Rule_guideline/1?language=en))

* Patient Activity Scale II (PAS II) for RA - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Patient_Activity_Scale_II_PAS_II_for_RA_guideline/1?language=en))

* Simplified Disease Activity Index (SDAI) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/SDAI/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/SDAI/1?language=sv))

* SLICC Criteria for Systemic Lupus Erythematosus (SLE) 2012 - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/SLICC_Criteria_for_Systemic_Lupus_Erythematosus_2012_guideline/1?language=en))

* Systemic Lupus Erythematosus Disease Activity Index 2000 (SLEDAI-2K) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/SLICC_Criteria_for_Systemic_Lupus_Erythematosus_2012_guideline/1?language=en))
...
----------
* ASA Physical Status/ASA Classification - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/ASA_Physical_Status_guideline/1?language=en))

* Cardiac Anesthesia Risk Evaluation Score (CARE) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Cardiac_Anesthesia_Risk_Evaluation_Score_CARE/0?language=en))

* CholeS Score for Duration of Laparoscopic Cholecystectomy - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/CholeS_Score_for_Duration_of_Laparoscopic_Cholecystectomy/1?language=en))

* LACE Index for Readmission - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/LACE_readmission_index/1?language=en))

* LRINEC Score for Necrotizing Soft Tissue Infection - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/LRINEC_Score_guideline/1?language=en))

* Maximum Allowable Blood Loss (ABL) Without Transfusion - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/ABL_Without_Transfusion_guideline/1?language=en))

* Pancreatic Fistula Risk Score - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Pancreatic_Fistula_Risk_Score_guideline/1?language=en))

* POSSUM for Operative Morbidity and Mortality Risk - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/POSSUM_Score_guideline/1?language=en))

* Preoperative Mortality Predictor Score (PMP) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Preoperative_Mortality_Predictor_PMP_Score_guideline/1?language=en))

* Revised Cardiac Risk Index for Pre-Operative Risk - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Revised_cardiac_risk_index_for_pre_operative_risk/1?language=en))

* Risk-E Score for Cardiac Surgery in Active Infective Endocarditis - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/RiskE_Score_guideline/1?language=en))

* Surgical Apgar Score for Postoperative Risk (SAS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Surgical_Apgar_Score_SAS_for_Postoperative_Risk/1?language=en))
...
----------
* ABC Score for massive transfusion - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/ABC_score_massive_transfusion/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/ABC_score_massive_transfusion/1?language=sv))
...
* CHIP (CT in Head Injury Patients) Prediction Rule - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/CHIP_prediction_rule/1?language=en))

* Focused Assessment with Sonography for Trauma (FAST) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/FAST_calculator/1?language=en))

* Injury Severity Score (ISS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/ISS/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/ISS/1?language=sv))

* Mangled Extremity Severity Score (MESS Score) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/MESS_Score/1?language=en))

* New Orleans/Charity Head Trauma/Injury Rule - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/New_Orleans_Charity_Head_Trauma_Injury_Rule/1?language=en))

* NEXUS Chest CT Decision Instrument for CT Imaging - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/NEXUS_Chest_CT_Decision_Instrument_for_CT_Imaging/1?language=en))

* NEXUS Chest Decision Instrument for Blunt Chest Trauma - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Nexus_chest_decision_instrument_for_blunt_chest_trauma/1?language=en))

* NEXUS Criteria for C-Spine Imaging - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/NEXUS_Criteria_C-Spine_Imaging_guideline/1?language=en))

* Pediatric NEXUS II Head CT Decision Instrument for Blunt Trauma - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Pediatric_NEXUS_II_Head_CT_Decision_guideline/1?language=en))

* Pediatric Trauma BIG Score - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Pediatric_trauma_BIG_score/1?language=en))

* Revised Trauma Score (RTS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/RTS/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/RTS/1?language=sv))

* Simplified Motor Score (SMS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/SMS/1?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/SMS/1?language=sv))

* Subaxial Injury Classification and Severity Scale (SLICS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Subaxial_Injury_Classification_and_Severity_Scale_SLICS/1?language=en))

* Thoracolumbar Injury Classification and Severity Scale (TLICS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Thoracolumbar_Injury_Classification_and_Severity_Scale_TLICS/1?language=en))

* Trauma Associated Severe Hemorrhage (TASH) Score - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/tash_score/1?language=en))
...
----------
* Revised Urinary Incontinence Scale (RUIS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Revised_urinary_incontinence_scale_ruis_guideline/1?language=en))

* Urine output fluid balance - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Urine_output_fluid_balance_Calculation/1?language=en))
...
* HOSPITAL Score Readmission Risk - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/HOSPITAL_score_readmission_risk/1?language=en))/([_IND_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/HOSPITAL_score_readmission_risk/1?language=id))

* ISTH DIC Score - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/DIC_Score/0?language=en))

* NAS Score - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Modified_Finnegan_Neonatal_Abstinence_Score/0?language=en))

* VIA Screening - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/VIA_Screening/0?language=en))
----------
...
* Oakland score for safe discharge after lower GI bleed - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Oakland_Score_guideline/1?language=en))

* Corona anxiety index - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Coronavirus_Anxiety_Scale/0?language=en))/([_SWE_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Coronavirus_Anxiety_Scale/0?language=sv))/([_FR_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Coronavirus_Anxiety_Scale/0?language=fr))/([_AR_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Coronavirus_Anxiety_Scale/0?language=ar-dz))
...
-----------
* AHA Antibiotic Prophylaxis AP Guidelines for dental procedures - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/aha_ap_dental_procedures/0?language=en))/([_ES-AR_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/aha_ap_dental_procedures/0?language=es-ar))

* CHEMO-RADIAT Score - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/chemo_radiat_score/0?language=en))

* ETDRS (Early Treatment Diabetic Retinopathy Study) Severity Scale - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/ETDRS_Diabetic_Retinopathy_SeverityRating_MacEdema/0?language=en))

* Humpty Dumpty Falls Scale (HDFS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/humpty_dumpty/0?language=en))

* Migraine - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/migraine/0?language=en))

* MUST tool - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/must_guideline/0?language=en))

* PECARN pediatric head injury/trauma algorithm - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/PECARN/0?language=en))

* Pediatric Mobility Risk Assessment Scoring - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/pediatric_mobility_risk_assessment_scoring_tool/0?language=en))

* Revised ASRS V1.1 for ADHD - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/ASRSv1.1_guideline/0?language=en))

* Sickle Cell RBC Exchange Volume calculator - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/Sickle_Cell_RBC_Exchange_Volume_guideline/0?language=en))

* Simplified Finnegan Neonatal Abstinence Scoring Tool (sFNAS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/simplified_fnas/0?language=en))/([_ES-AR_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/simplified_fnas/0?language=es-ar))

* Simplified Functional Movement Disorder Rating Scale (S-FMDRS) - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/S-FMDRS_guideline/0?language=en))

* STOP-BANG score - ([_ENG_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/STOP-BANG-Score/0?language=en))/([_ES_](https://modelling.cds-platform.com/ckm/view/ckm-cambio-community/STOP-BANG-Score/0?language=es))
